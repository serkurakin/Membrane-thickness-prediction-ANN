...
был интерполирован на сетку для соответствия с диапазоном, представленным в синтетических данных. Реальные данные также обрабатывались с помощью 
...
предсказания толщины липидной мембраны. Нейронная сеть была успешно обучена на 100 эпохах. Метрика MAE на тестовой выборке равна около 0.85 А, а r2 score - 0.93, что является хорошим результатом по предсказанию 
